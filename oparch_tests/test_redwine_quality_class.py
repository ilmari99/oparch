...
if __name__ == "__main__":
    ...
    df = multip_rows(df,mask_cond=lambda df : df["quality"].isin([1,2,3,7,8,9]))
    ...
    opt.set_default_misc(epochs=50,batch_size=256,learning_metric="NEG_VALIDATION_ACCURACY",verbose=0,validation_split=0.25)
